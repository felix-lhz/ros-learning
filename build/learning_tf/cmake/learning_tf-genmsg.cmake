...
set(MSG_I_FLAGS "-Itf:/opt/ros/noetic/share/tf/cmake/../msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg;-Isensor_msgs:/opt/ros/noetic/share/sensor_msgs/cmake/../msg")
...
if(TARGET tf_generate_messages_cpp)
  add_dependencies(learning_tf_generate_messages_cpp tf_generate_messages_cpp)
endif()
...
if(TARGET tf_generate_messages_eus)
  add_dependencies(learning_tf_generate_messages_eus tf_generate_messages_eus)
endif()
...
if(TARGET tf_generate_messages_lisp)
  add_dependencies(learning_tf_generate_messages_lisp tf_generate_messages_lisp)
endif()
...
if(TARGET tf_generate_messages_nodejs)
  add_dependencies(learning_tf_generate_messages_nodejs tf_generate_messages_nodejs)
endif()
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/learning_tf)
  install(CODE "execute_process(COMMAND \"/home/felix/miniconda3/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/learning_tf\")")
  # install generated code
  install(
...
if(TARGET tf_generate_messages_py)
  add_dependencies(learning_tf_generate_messages_py tf_generate_messages_py)
endif()
